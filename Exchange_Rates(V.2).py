...
while True:
    try:
        ...
        if option == 1:
            ...
            USD_SOUP = BeautifulSoup(USD_LKR, features = "lxml")
            print_s(">> Done!\n\n")
        ...
        if option == 2:
            ...
            AUD_SOUP = BeautifulSoup(AUD_LKR, features = "lxml")
            ...
            GPB_SOUP = BeautifulSoup(GPB_LKR, features = "lxml")
            ...
            CAD_SOUP = BeautifulSoup(CAD_LKR, features = "lxml")
            ...
            EUR_SOUP = BeautifulSoup(EUR_LKR, features = "lxml")
            ...
            JPY_SOUP = BeautifulSoup(JPY_LKR, features = "lxml")
            ...
            NZD_SOUP = BeautifulSoup(NZD_LKR, features = "lxml")
            ...
            CHF_SOUP = BeautifulSoup(CHF_LKR, features = "lxml")
